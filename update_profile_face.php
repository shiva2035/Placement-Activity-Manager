		  ...
		  if ($_FILES["file"]["error"] > 0)
				...
				//else
					//{
						...
						echo "<center><br><br><b><u>Flie ".$_FILES["file"]["name"]."<b> Your Profile-Face Photo is Successfully Updated<br/>";
						echo "<center><br><br><b><u><br/><a href=\"login.php\">Go Back to Home</a>";
