...
<tr style="{background-color:#c8c8c8;font-size:15;color:black;}"><th>-</th><th>-</th><th>-</th><th>-</th><th>-</th><th>-</th></tr>
</table>
</fieldset>
</td></tr>
<tr><td id="const1">Student Resume:</td><td id="const2"><a href="viewPDF.php?id=<? echo $row['uname'];?>&vtype=student"><? echo $row['uname'];?></a></td></tr>
</table></fieldset>
